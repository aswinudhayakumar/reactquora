...
class Question extends Component {
    ...
    submit = () => {
        ...
        if (this.state.error.text === false) {
            ...
            Axios.post(link, obj).then(res => {
                ...
                toast.error("Answered Successfully!");
    ...
    delquestion = () => {
        var link = "http://localhost:8123/deletequestion"
        var obj = {
            ID: this.state.questionid
        }
        Axios.post(link, obj).then(res => {
        ...
        return (
            <div className="container-fluid ind-question-box">
                ...
                <div className="row">
                    ...
                    <div className="col-1">
                    {this.state.userid === this.props.auth.Id ? <div className="col-1 close-ques"> <span data-toggle="modal" data-target="#myModal" ><img src={del} height="25" width="25" className="closepost" /></span> </div> : ''}
                    </div>
                </div>
                        ...
                        <div class="modal-dialog">
                            <div class="modal-content">
                                ...
                                <div class="modal-footer">
                                    <button type="button" class="btn btn-danger" onClick={this.delquestion} data-dismiss="modal" >Delete</button>
